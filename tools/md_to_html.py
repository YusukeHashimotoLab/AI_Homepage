#!/usr/bin/env python3
"""
Markdown to HTML Converter for MI Knowledge Hub

Converts Markdown files with YAML front matter to standalone HTML pages.
...
def create_html_template(title: str, body: str, metadata: Dict[str, Any]) -> str:
    ...
    reading_time = metadata.get('total_reading_time', metadata.get('reading_time', '不明'))
